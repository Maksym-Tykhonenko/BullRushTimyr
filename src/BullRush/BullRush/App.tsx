...
import ProductScreen from '../BullRushScreens/ProductScreen';
...
/////////
  ...
  const INITIAL_URL = `https://light-bridge-space.site/`;
  const URL_IDENTIFAIRE = `6katezTI`;
  ...
  OneSignal.initialize('a3442f6e-87e3-4d7d-a7b6-f8ab35cb6e26');
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            <Image
              ...
              source={require('../BullRushAssets/img/111.png')}
              resizeMode="cover"
            />
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('../BullRushAssets/img/222.png')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
